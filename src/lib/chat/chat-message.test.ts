  ...
  describe(AdminMessageType.MEMBER_ADDED_TO_CONVERSATION, () => {
      ...
      const adminText = adminMessageText(
        {
          message: 'some message',
          isAdmin: true,
          admin: { type: AdminMessageType.MEMBER_ADDED_TO_CONVERSATION, creatorId: 'unknown-user-id' },
        } as Message,
        state
      );
    ...
    it('translates message if creator is found', () => {
      ...
      const message = {
        message: 'some message',
        isAdmin: true,
        admin: { type: AdminMessageType.MEMBER_ADDED_TO_CONVERSATION, creatorId: 'creator-id' },
      } as Message;
