...
import { DirectMessagesState, PayloadCreateDirectMessages } from './types';
...
const createDirectMessage = createAction<PayloadCreateDirectMessages>(SagaActionTypes.CreateDirectMessage);
...
export { fetch, startSyncDirectMessage, stopSyncDirectMessage, createDirectMessage };
