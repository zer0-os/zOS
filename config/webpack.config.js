  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        // @zOS: fix for remark-emoji dependency in zUI
      ...
      // @z0S: fallback for nodejs builtin modules
      fallback: {
    ...
    plugins: [
      // z0S: fix for nodejs builtin modules
    ...
    performance: false,
    // @z0S: Ignore source-map-loader warnings in node_modules
    ignoreWarnings: [
